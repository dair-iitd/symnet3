...
output_filename = 'result_csvs/ippc_num_head_results.csv'
std_dev = False
def get_score(domain, models, instances):
    ...
    for model in models:
        if model != 'random' and model != 'prost' and 'symnet2' in model:
            ...
            ptr = open(f'/scratch/cse/dual/cs5180404/expt/uai2023_after/ippc_4heads/{model}/{domain}10x10-15x15-symnet3prost/testing_200.csv')
        elif model == 'random':
